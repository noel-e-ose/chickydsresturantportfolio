...
export const Ordercoke = () =>{
    ...
    const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        formDataToSend.append('item_price', '1.2');
        formDataToSend.append('cart_item', 'Coca-Cola');
        try {
            ...
            <Container>
                ...
                <Row>
                    <Col className='orderhldr'>
                        <div>
                            <h2 className='hedr'>Coca-Cola</h2>
                            <img  src={coke} className='orderpic'/>
                            <div>
