...
export const Orderfrenchfriesketchup = () =>{
    ...
    const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        formDataToSend.append('item_price', '6');
        formDataToSend.append('cart_item', 'Fries & Ketchup');
        try {
            ...
            <Container>
                ...
                <Row>
                    <Col className='orderhldr'>
                        <div>
                            <h2 className='hedr'>Fries & Ketchup</h2>
                            <img  src={friesndketchup} className='orderpic'/>
                            <div>
