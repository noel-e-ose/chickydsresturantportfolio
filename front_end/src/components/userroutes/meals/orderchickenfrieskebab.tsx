import chickenndfrieskebab from '../../../images/chickenndfrieskebab.png'
...
export const Orderchickenfrieskebab = () =>{
    ...
    const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        formDataToSend.append('item_price', '6.5');
        formDataToSend.append('cart_item', 'Chicken Fries Kebab');
        try {
            ...
            <Container>
                ...
                <Row>
                    <Col className='orderhldr'>
                        <div>
                            <h2 className='hedr'>Chicken Fries Kebab</h2>
                            <img  src={chickenndfrieskebab} className='orderpic'/>
                            <div>
