...
export const Orderpromo = () =>{
    ...
    const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        formDataToSend.append('item_price', '20.5');
        formDataToSend.append('cart_item', 'PromoOrder');
        try {
            ...
            <Container>
                ...
                <Row>
                    <Col className='orderhldr'>
                        <div>
                            <h2 className='hedr'>Chicky D's Chicken & Fries PROMO</h2>
                            <img  src={promopic} className='orderpic'/>
                            <div>
