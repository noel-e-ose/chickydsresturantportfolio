import chicken from '../../../images/chickenol.jpg'
...
export const Orderchickenwings = () =>{
    ...
    const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        formDataToSend.append('cart_item', 'Chicken wings');
        try {
            ...
            <Container>
                ...
                <Row>
                    <Col className='orderhldr'>
                        <div>
                            <h2 className='hedr'>Chicken wings</h2>
                            <img  src={chicken} className='orderpic'/>
                            <div>
