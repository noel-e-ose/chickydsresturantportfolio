...
export const Orderfrenchfries = () =>{
    ...
    const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        formDataToSend.append('item_price', '5');
        formDataToSend.append('cart_item', 'French Fries');
        try {
            ...
            <Container>
                ...
                <Row>
                    <Col className='orderhldr'>
                        <div>
                            <h2 className='hedr'>French Fries</h2>
                            <img  src={fries} className='orderpic'/>
                            <div>
