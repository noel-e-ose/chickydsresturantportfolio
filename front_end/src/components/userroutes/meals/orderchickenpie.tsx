import chickenpie from '../../../images/chickenpieol.jpg'
...
export const Orderchickenpie = () =>{
    ...
    const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        formDataToSend.append('item_price', '5.41');
        formDataToSend.append('cart_item', 'Chicken-pie');
        try {
            ...
            <Container>
                ...
                <Row>
                    <Col className='orderhldr'>
                        <div>
                            <h2 className='hedr'>Chicken-pie</h2>
                            <img  src={chickenpie} className='orderpic'/>
                            <div>
