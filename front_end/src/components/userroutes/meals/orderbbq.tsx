import bbq from '../../../images/bbqsauce.jpg'
...
export const Orderbbq = () =>{
    ...
    const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        formDataToSend.append('item_price', '1');
        formDataToSend.append('cart_item', 'Bbq Sauce');
        try {
            ...
            <Container>
                ...
                <Row>
                    <Col className='orderhldr'>
                        <div>
                            <h2 className='hedr'>Bbq Sauce</h2>
                            <img  src={bbq} className='orderpic'/>
                            <div>
